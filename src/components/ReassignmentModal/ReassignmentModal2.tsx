...
import { IdentitySummary } from "../../interfaces/accessItemsResponse";

interface ReassignmentModal2Props {
  open: boolean;
  onClose: () => void;
  onSubmit: (reassignTo: Identity | null | undefined, reason: string) => void;
  selectedItemDetail: IdentitySummary | undefined;
}

const ReassignmentModal2: React.FC<ReassignmentModal2Props> = ({
  open,
  onClose,
  onSubmit,
  selectedItemDetail,
    ...
    >
      ...
      >
        ...
        <Typography
          ...
          component="h2"
        >
          Identity: {selectedItemDetail?.name}
        </Typography>
        <Autocomplete
          disablePortal
...
export default ReassignmentModal2;
